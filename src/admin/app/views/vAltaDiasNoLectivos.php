            ...
            <div class="col-md-6">
                ...
                <form class="mt-4" method="POST" action="../admin/index.php?c=DiasNoLectivos&m=insertar">
                    <div class="mb-4">
                        ...
                        <input type="date" class="form-control bg-light" id="dia" name="fecha" value="<?php echo isset($_POST['fecha'])?$_POST['fecha']:''; ?>">
                    </div>
                    <div class="mb-4">
                        <label for="motivo" class="form-label">MOTIVO</label>
                        <input type="text" class="form-control bg-light" id="motivo" name="motivo" value="<?php echo isset($_POST['motivo'])?$_POST['motivo'] : ''; ?>">
                    </div>
